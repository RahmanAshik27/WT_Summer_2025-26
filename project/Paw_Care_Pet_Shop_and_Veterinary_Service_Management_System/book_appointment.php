...
if ($doctor_id > 0) {
    $sql = "SELECT d.doctor_id, d.specialization, d.qualification, d.consultation_fee, d.available_days, d.available_time, d.status, u.full_name, u.profile_image FROM doctors d JOIN users u ON d.user_id = u.user_id WHERE d.doctor_id = $doctor_id AND u.status = 'active' LIMIT 1";
...
<main class="appointment-container">
    ...
    <aside class="appointment-sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="doctor_profile.php?doctor_id=<?php echo (int)$doctor["doctor_id"]; ?>" class="menu-btn">Doctor Profile</a>
            <a href="login.php" class="menu-btn">Customer Login</a>
        </nav>
    ...
    <section class="appointment-content">
        ...
        <div class="page-heading">
            ...
            <span>Choose your preferred date and time for your pet consultation.</span>
        </div>
        ...
        <div class="appointment-box">
            ...
            <div class="selected-doctor">
                ...
                <div class="doctor-info-row">
                    ...
                    <span><?php echo htmlspecialchars($doctor["available_days"]); ?></span>
                </div>

                <div class="doctor-info-row">
                    <strong>Available Time</strong>
                    <span><?php echo htmlspecialchars($doctor["available_time"]); ?></span>
                </div>

                <div class="doctor-info-row">
                    <strong>Consultation Fee</strong>
                    <span>৳<?php echo number_format((float)$doctor["consultation_fee"], 2); ?></span>
                </div>
            ...
            <div class="appointment-form-box">
                ...
                <form action="book_appointment.php?doctor_id=<?php echo (int)$doctor["doctor_id"]; ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="reason" name="reason" rows="4" placeholder="Write a short reason for the appointment..." required></textarea>
                    </div>
